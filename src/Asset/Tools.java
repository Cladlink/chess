...
public class Tools {
    ...
    public static final String REINEBLANCHE = "";
    public static final String ROINOIR = "";
    public static final String ROIBLANC = "";
    public static final String FOUNOIR = "";
    public static final String FOUBLANC = "";
    public static final String CAVALIERNOIR = "";
